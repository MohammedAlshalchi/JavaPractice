...
public int numberOfStars;
    ...
    public String toString() {
        return "Restaurant{" +
                ...
                ", server list=" + serverList.size() +
                ", chef list=" + chehList.size() +
                '}';
    }

    public ArrayList <Server> serverList  = new ArrayList<>();
    public ArrayList <Chef> chehList = new ArrayList();
...
public void hireChef(Chef [] chefs){
    chehList.addAll(Arrays.asList(chefs));
}

public void terminateChef(int employeeID){
    chehList.removeIf(p -> p.employeeID== employeeID);
}
